    ...
    <section class="banner">
      <div class="swiper-container">
        <div class="swiper-wrapper h-700 h-sm-500">
          <div class="swiper-slide align-items-center d-flex responsive-overlap-md bg-overlay-black-30" style="background-image:url(images/slider/09.jpg); background-size: cover;">
            <div class="swipeinner container">
              <div class="row justify-content-center">
                <div class="col-lg-9 col-md-10 text-center position-relative">
                  <h1 data-swiper-animation="fadeInUp" data-duration="1s" data-delay="0.25s">An I.T solution company you can trust</h1>
                  <a class="btn btn-dark btn-round text-white" data-swiper-animation="fadeInUp" data-duration="1s" data-delay="0.75s" href="/contact">Get Started Now<i class="fas fa-arrow-right ps-3"></i></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide align-items-center d-flex responsive-overlap-md bg-overlay-black-60" style="background-image:url(images/slider/0a.jpg); background-size: cover; background-position: center center;">
            <div class="swipeinner container">
              <div class="row justify-content-center">
                <div class="col-lg-9 col-md-11 text-center position-relative">
                  <h2 data-swiper-animation="fadeInUp" data-duration="1s" data-delay="0.25s" font style="color:white;">We are Quaphtic Services. We help drive change with technology.</h2>
      ...
      <div class="container">
          ...
          <div class="col-md-6 col-lg-3 mb-sm-5 mb-4">
            <div class="category-box category-box-style-02 text-center active">
              <div class="category-icon">
                ...
                <h5 class="category-title mb-0">HelpDesk Management System</h5>
              </div>
              <ul class="category-list">
                <li><a href="#">Simple & Intuitiven Processes</a></li>
                <li><a href="#">Robust Documentation</a></li>
                <li><a href="#">Selection of Service Provider</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-sm-5 mb-4">
            <div class="category-box category-box-style-02 text-center">
              <div class="category-icon">
                ...
                <h5 class="category-title mb-0">Project Management Office System</h5>
              </div>
              <ul class="category-list">
          ...
          <div class="col-md-6 col-lg-3 mb-sm-5 mb-4">
            <div class="category-box category-box-style-02 text-center">
              <div class="category-icon">
                ...
                <h5 class="category-title mb-0">Enterprise Resource Planning solution</h5>
              </div>
              <ul class="category-list">
        ...
        <div class="row">
          <div class="col-12 d-md-flex justify-content-center align-items-center">
            ...
            <a href="/contact" class="btn btn-primary-round btn-round mx-0 mx-md-3">Click Here<i class="fas fa-arrow-right ps-3"></i></a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-9 mt-3 mt-md-0">
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="mission-and-vision" role="tabpanel" aria-labelledby="mission-and-vision-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="images/vision&mission.png" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    ...
                    <p class="mb-4">We help client drive business transformation in seamless manner to guarantee a high return on IT investment.</p>
                    <h4><i class="flaticon-eye text-primary me-2"></i> Our Vision</h4>
                    <p class="mb-4">With interest in agriculture, technology and telecoms, trading, and FMCG our flagship business is in Information and Communication Technology.</p>
                    <h6 class="fw-normal text-muted mt-4"> Quaphtic prides herself as a company at the forefront of promoting and advocating Business/IT alignment with our ‘Measure Your Information Technology-MYIT’ concept.</h6>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="technology-partners" role="tabpanel">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="images/partner.jpg" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                    ...
                    <div class="row">
                      <div class="col-lg-4 mb-4">
                        <img class="img-fluid grayscale p-2" src="images/partner/hp.png" alt="">
                      </div>
                      <div class="col-lg-4 mb-4">
                        <img class="img-fluid grayscale p-2" src="images/partner/exin.png" alt="">
                      </div>
                      <div class="col-lg-4 mb-4">
                        <img class="img-fluid grayscale p-2" src="images/partner/microsoft.png" alt="">
                      </div>
                    </div>
                    <div class="mt-4">
              ...
              <div class="tab-pane fade" id="careers-with-us" role="tabpanel" aria-labelledby="careers-with-us-tab">
                <div class="row">
                  <div class="col-sm-5 align-self-lg-center mb-4 mb-sm-0">
                    <img class="img-fluid rounded" src="images/career.png" alt="">
                  </div>
                  <div class="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
    ...
    <section class="space-ptb bg-dark  dark-background category category-list-style-01">
      <div class="container">
        <div class="row align-items-center pb-4 pb-md-5">
          ...
          <div class="col-lg-6">
            <p class="lead text-white mb-0">We offer expertise across various industries. See some of the industries we have vast experience working in as a full-service I.T agency.</p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title is-sticky">
              ...
              <p class="mb-4">Please take a look at the range of <b>IT solution</b> services we offer to your brand as a full-service leading agency.</p>
